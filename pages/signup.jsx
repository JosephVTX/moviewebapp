...
const SignUp = () => {
  ...
  const [isRepeatPasswordFocus, setIsRepeatPasswordFocus] = useState(false)
  ...
  const hrRepeatPasswordClass = classNames({
    'border-t-white': isRepeatPasswordFocus,
    'border-t-terciary_others': !isRepeatPasswordFocus,
  })
  ...
  const handleFocusRepeatPassword = e => {
    setIsRepeatPasswordFocus(true)
  }

  const handleBlurRepeatPassword = e => {
    setIsRepeatPasswordFocus(false)
  }

  return (
    <div className="px-6 flex flex-col justify-center items-center">
      <div className="mt-[48px] mb-[73.6px]">
        <Image src="/logo.svg" alt="logo icon" width={32} height={25.6} />
      </div>
      <div
        id="signup"
        className="bg-secondary_background max-w-[327px] md:min-w-[400px] min-h-[420px] md:min-h-[418px] p-12 rounded-[10px] md:rounded-[20px]"
      >
        <h2 className="text-l text-white mb-10">Sign Up</h2>
        <form className="flex flex-col">
          ...
          <div>
            <input
              ...
              autoComplete="off"
              className="outline-none border-none bg-transparent text-base placeholder:text-terciary_others focus:text-white px-4 pb-4"
              onFocus={handleFocusRepeatPassword}
              onBlur={handleBlurRepeatPassword}
            />
            <hr className={hrRepeatPasswordClass} />
          </div>
        ...
        <div className="md:text-center">
          ...
          <span className="text-primary_red text-base">Login</span>
        </div>
      </div>
    </div>
  )
